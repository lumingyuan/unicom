...
-(NSDictionary*)location2map:(BMKLocation*)location state:(BMKLocationNetworkState) state{
    ...
    dict[@"state"] = @(state);
    if (location != nil && location.location != nil) {
        dict[@"latitude"] = @(location.location.coordinate.latitude);
        dict[@"longitude"] = @(location.location.coordinate.longitude);
        dict[@"altitude"] = @(location.location.altitude);
    }
    if (rgcData != nil) {
        dict[@"country"] = rgcData.country;
        dict[@"countryCode"] = rgcData.countryCode;
        dict[@"province"] = rgcData.province;
        dict[@"city"] = rgcData.city;
        dict[@"cityCode"] = rgcData.cityCode;
        dict[@"district"] = rgcData.district;
        dict[@"street"] = rgcData.street;
        dict[@"streetNumber"] = rgcData.streetNumber;
        dict[@"adCode"] = rgcData.adCode;
        dict[@"locationDescribe"] = rgcData.locationDescribe;
    }
